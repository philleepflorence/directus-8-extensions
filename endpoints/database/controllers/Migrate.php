...
/*
	...
	Description - Migrate the data and/or schema of a database collection - useful for updating collections and databases.
	Collections - Directus Collections 
	Endpoint - /app/custom/database/migrate
...
{	
    public function __invoke (Request $request, Response $response)
    {
	    ...
	    $result = Database::Migrate($_REQUEST, $debug); 
